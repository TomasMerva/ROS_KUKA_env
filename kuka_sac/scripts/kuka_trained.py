...
class trainedAgent():
    def __init__(self):
        ...
        self.model = tf.train.import_meta_graph\
            ("/home/tomas/catkin_ws/src/kuka_sac/saved_model/sac_KUKAReach_trained_model.meta")
        self.model.restore(self.sess, tf.train.latest_checkpoint("/home/tomas/catkin_ws/src/kuka_sac/saved_model/"))
